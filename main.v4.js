...
function updateScoreBadge(val){
  ...
  { name:'Knogle', idle:'./assets/Knogle_Fly.png', flap:'./assets/Knogle_Regular.png', scale: 1.10},
  { name:'Orchard', idle:'./assets/Orchard_Fly.png', flap:'./assets/Orchard_Regular.png', scale: 1.10},
